...
if start_index != -1 and end_index != -1:
    header_part = content[:start_index]
    footer_part = content[end_index:]
...
"""
    ...
    new_content = header_part + product_detail_content + '\n    ' + footer_part
    with open('product-detail.html', 'w', encoding='utf-8') as fw:
        fw.write(new_content)
    print("product-detail.html generated successfully.")
else:
